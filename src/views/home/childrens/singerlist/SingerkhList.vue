  ...
  <div style="display: flex;
    ...
    <div v-if="permission" style="width:100%;">
      <div id="musiclist">
        ...
        <music-audition-kh :userInfo="userInfo" @editaudition="editaudition" v-if="auditionType"></music-audition-kh>
...
import MusicAuditionKh from "./singerlistchildrens/MusicAuditionKh.vue";
